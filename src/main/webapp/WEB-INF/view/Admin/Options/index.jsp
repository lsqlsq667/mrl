            ...
            <div class="layui-tab-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-upload">
                            <div class="layui-upload-list" style="">
                                <img class="layui-upload-img" src="${option.optionAboutsiteQq}" id="demo3" width="100"
                                     height="100">
                                <p id="demoText3"></p>
                            </div>
                            <button type="button" class="layui-btn" id="test3">上传图片</button>
                            <input type="hidden" id="optionAboutsiteQq" name="optionAboutsiteQq" value="${option.optionAboutsiteQq}">
                        </div>
                    </div>
                    <div class="layui-form-mid layui-word-aux">建议 430px*430px</div>
